    ...
    def do_GET(self):
        ...
        if parsed_path in ("/", "/login"):
            ...
            try:
                ...
                html = f'''<!DOCTYPE html><html class="light" lang="es"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><title>Editar Salon | UTP Admin</title><script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script><script id="tailwind-config">tailwind.config={{theme:{{extend:{{colors:{{"surface-container-lowest":"#ffffff","surface-container-highest":"#e1e3e4","secondary":"#585f64","primary":"#840015","surface-container":"#edeeef","on-primary":"#ffffff","on-background":"#191c1d","on-surface":"#191c1d","surface":"#f8f9fa","background":"#f8f9fa","error":"#ba1a1a","outline":"#906f6d","surface-container-high":"#e7e8e9","surface-container-low":"#f3f4f5","surface-dim":"#d9dadb","surface-bright":"#f8f9fa","inverse-surface":"#2e3132","inverse-primary":"#ffb3af","primary-container":"#b00020","on-primary-container":"#ffbbb8","on-primary-fixed":"#410006","on-primary-fixed-variant":"#930019","primary-fixed":"#ffdad8","primary-fixed-dim":"#ffb3af","secondary-container":"#dce3e9","on-secondary":"#ffffff","on-secondary-container":"#5e656a","on-secondary-fixed":"#161d21","on-secondary-fixed-variant":"#41484c","secondary-fixed":"#dce3e9","secondary-fixed-dim":"#c0c7cd","tertiary":"#384045","tertiary-container":"#4f575d","on-tertiary":"#ffffff","on-tertiary-container":"#c5ccd3","on-tertiary-fixed":"#151d21","on-tertiary-fixed-variant":"#40484d","tertiary-fixed":"#dce3ea","tertiary-fixed-dim":"#c0c7ce","error-container":"#ffdad6","on-error":"#ffffff","on-error-container":"#93000a","surface-variant":"#e1e3e4","on-surface-variant":"#5b403e","outline-variant":"#e4bdbb","surface-tint":"#bc1127"}}}}}});</script><link href="https://fonts.googleapis.com/css2?family=Libre+Franklin:wght@100;300;400;500;600;700;800;900&family=Courier+Prime&display=swap" rel="stylesheet"/><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet"/><style>body{{background:#F8F9FA;color:#191C1D;font-family:'Libre Franklin',sans-serif}}.material-symbols-outlined{{font-variation-settings:'FILL'0,'wght'400,'GRAD'0,'opsz'24;vertical-align:middle}}.glass-panel{{background:rgba(255,255,255,0.7);backdrop-filter:blur(12px);border:1px solid #e6e8eb}}</style></head><body class="p-8">
