...
<input class="pl-10 pr-4 py-2 bg-surface border-none rounded-full text-label-md w-36 sm:w-64 focus:ring-1 focus:ring-primary" placeholder="Buscador global..." type="text"/>
</div>
...
<div class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold text-sm shrink-0">A</div>
</div>
</div>
</header>
<!-- Page Canvas -->
